...
class Create_GUI:
    ...
    def create_main_menu(self):
        ...
        if True:
            ...
            self.btn_handler.buttons.append(Button(image_path, "self.btn_handler.clear_screen()", (100, 99), self.btn_handler, scale=8))
        if True:
        ...
        if True:
            ...
            self.btn_handler.buttons.append(Button(image_path, "sys.exit()", (100, 99), self.btn_handler, scale=8))
        if True:
